...
<div class="footer-bottom">
    <div class="ak-container">
        ...
        <div class="site-info">
          ...
          ?> - <?php  
              printf( __( 'CNPJ - 17.753.032/0001-60 | Razão Social - Studio XV Cabeleireiros LTDA-ME | Endereço - Estrada Francisco da Cruz Nunes nº 5428, Loja 129, Shopping Barravento, Niterói, RJ, CEP - 24325-340' ), '<a href="'.esc_url('https://wordpress.org').'">AccessPress Store</a>', '<a href="'.esc_url('https://accesspressthemes.com' ).'">AccessPress Themes</a>'  ); 
          ?>
        </div><!-- .site-info -->
    </div>
</div>
