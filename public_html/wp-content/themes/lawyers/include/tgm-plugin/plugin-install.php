...
function mt_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'MT Lawyers Custom Post Types Plugin', // The plugin name.
			'slug'               => 'mt-plugin', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/include/tgm-plugin/mt-lawyers-custom-post-types.zip', // The plugin source.
	...
	$config = array(
		'id'           => 'mt_tgm',                 // Unique ID for hashing notices for multiple instances of TGMPA.
