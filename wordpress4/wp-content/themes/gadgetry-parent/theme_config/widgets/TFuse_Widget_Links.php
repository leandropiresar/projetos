...
class TFuse_Widget_Links extends WP_Widget {
	...
	function __construct() {
        ...
        parent::__construct('links', __('TFuse Links','tfuse'), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		$before_widget = '<div class="widget-container widget_links">';
		$after_widget = '</div>';
	...
	function form( $instance ) {
		...
		//Defaults
		$instance = wp_parse_args( (array) $instance, array( 'title' => '', 'images' => '', 'name' => true, 'description' => false, 'rating' => false, 'category' => false ) );
