...
<span class="newsletter_apikey_holder mailchimp_apikey">
    ...
    <?php
    $method = $api_option_mailchimp['type'];
    echo $this->optigen->$method($api_option_mailchimp);
    ?> 
</span>
<span class="newsletter_apikey_holder campaignmonitor_apikey">
    <?php _e('CampaignMonitor API key:', 'tfuse') ?>
    <?php
    $method = $api_option_campaignmonitor['type'];
    echo $this->optigen->$method($api_option_campaignmonitor);
    ?> 
</span>
