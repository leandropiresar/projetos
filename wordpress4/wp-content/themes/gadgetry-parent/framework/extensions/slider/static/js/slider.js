...
jQuery(document).ready(function($) {
    ...
    $(document).on('click','#save_changes_slide',function(){
        slide_settings={};
        for(var prop in tf_script.slide_ids) {
    ...
    $(document).on('click','#cancel_changes_slide',function(){
    ...
    $(document).on('click','#save_slider',function(){
    ...
    $(document).on('click','.tf_delete_slider',function(){
