...
//                return;
            ...
            foreach ($options as $option) {
                if ($option['type'] == 'metabox') {
                    ...
                    $method = "post_{$option['type']}";
                    $this->optisave->$method($option, $tfuse_post_options);
                } else {
    ...
    function save_taxonomy_options_init($term_id, $tt_id, $taxonomy) {
        ...
        foreach ($options as $option) {
            if ($this->optisave->has_method("taxonomy_{$option['type']}")) {
                $method = "taxonomy_{$option['type']}";
                $this->optisave->$method($option, $term_id, $tfuse_taxonomy_options);
            } else {
