<?php
/**
 * Recent Posts Shortcode Class
 *
 * @since 4bzCore 1.0.0
 *
 * @package 4bzCore 
 * @subpackage class-4bzcore-shortcode-recent-posts.php
 */
...
if ( ! class_exists( 'FourBzCore_Shortcode_Recent_Posts' ) ) {  
	class FourBzCore_Shortcode_Recent_Posts {
		/**
		...
		public function __construct() {
			$this->id_base = 'fourbzcore-recent-posts-';
		}
