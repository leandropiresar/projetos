<?php
/**
 * Featured Posts Shortcode Class
 *
 * @since 4bzCore 1.0.0
 *
 * @package 4bzCore 
 * @subpackage class-4bzcore-shortcode-featured-posts.php
 */
...
if ( ! class_exists( 'FourBzCore_Shortcode_Featured_Posts' ) ) {  
	class FourBzCore_Shortcode_Featured_Posts {
		/**
		...
		public function __construct() {
			$this->id_base = 'fourbzcore-featured-posts-';
		}
