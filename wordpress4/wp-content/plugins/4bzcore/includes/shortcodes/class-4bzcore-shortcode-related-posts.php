<?php
/**
 * Related Posts Shortcode Class
 *
 * @since 4bzCore 1.0.0
 *
 * @package 4bzCore 
 * @subpackage class-4bzcore-shortcode-related-posts.php
 */
...
if ( ! class_exists( 'FourBzCore_Shortcode_Related_Posts' ) ) {  
	class FourBzCore_Shortcode_Related_Posts {
		/**
		...
		public function __construct() {
			$this->id_base = 'fourbzcore-related-posts-';
		}
