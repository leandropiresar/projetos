<?php
/**
 * Popular Posts Shortcode Class
 *
 * @since 4bzCore 1.0.0
 *
 * @package 4bzCore 
 * @subpackage class-4bzcore-shortcode-popular-posts.php
 */
...
if ( ! class_exists( 'FourBzCore_Shortcode_Popular_Posts' ) ) {  
	class FourBzCore_Shortcode_Popular_Posts {
		/**
		...
		public function __construct() {
			$this->id_base = 'fourbzcore-popular-posts-';
		}
